...
# Memory: ARM_A9_HPS_axi_sdram
MEM_0 := ARM_A9_HPS_axi_sdram
$(MEM_0)_NAME := ARM_A9_HPS_axi_sdram
$(MEM_0)_START := 0x40000000
$(MEM_0)_END := 0x7fffffff
$(MEM_0)_SPAN := 0x40000000
$(MEM_0)_HIERARCHICAL_PATH := ARM_A9_HPS.axi_sdram
$(MEM_0)_WIDTH := 31
$(MEM_0)_HEX_DATA_WIDTH := 31
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0


# Memory: Onchip_SRAM
MEM_1 := Computer_System_Onchip_SRAM
$(MEM_1)_NAME := Onchip_SRAM
...
$(MEM_1)_HIERARCHICAL_PATH := Onchip_SRAM
$(MEM_1)_WIDTH := 32
...
.PHONY: Onchip_SRAM
Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
MEM_3 := Computer_System_VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
$(MEM_3)_NAME := VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
...
$(MEM_3)_START := 0x09000000
$(MEM_3)_END := 0x09001fff
$(MEM_3)_SPAN := 0x00002000
$(MEM_3)_HIERARCHICAL_PATH := VGA_Subsystem.Char_Buf_Subsystem.Onchip_SRAM
$(MEM_3)_WIDTH := 32
...
VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
